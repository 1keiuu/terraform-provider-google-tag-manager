...
page_title: "gtm_trigger Data Source - google-tag-manager"
subcategory: ""
description: |-
  Gets a GTM Trigger.
---

# gtm_trigger (Data Source)
...
- `path` (String) GTM Trigger's API relative path. The response value is returned in the same attribute.
