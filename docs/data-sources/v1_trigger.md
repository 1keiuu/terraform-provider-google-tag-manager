...
page_title: "gtm_v1_trigger Data Source - google-tag-manager"
subcategory: ""
description: |-
  Gets a GTM Trigger.
---

# gtm_v1_trigger (Data Source)
...
- `trigger_id` (String) The GTM Trigger ID. The response value is returned in the same attribute.
