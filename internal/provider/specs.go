...
func resourceSpecs() []ResourceSpec {
	return []ResourceSpec{
		{TypeName: "gtm_account_settings", Version: "v2", SchemaRef: "Account", ReadMethod: "accounts.get", UpdateMethod: "accounts.update", AdoptExisting: true},
		...
		{TypeName: "gtm_v1_account_settings", Version: "v1", SchemaRef: "Account", ReadMethod: "accounts.get", UpdateMethod: "accounts.update", AdoptExisting: true},
		...
		{TypeName: "gtm_v1_container", Version: "v1", SchemaRef: "Container", Collection: "containers", IDField: "containerId", CreateMethod: "accounts.containers.create", ReadMethod: "accounts.containers.get", UpdateMethod: "accounts.containers.update", DeleteMethod: "accounts.containers.delete", RequiredFields: []string{"name", "usageContext"}, ComputedFields: []string{"publicId", "tagIds"}},
